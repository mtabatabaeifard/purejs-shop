...
signinBtn.addEventListener("click", (e) => {
  e.preventDefault();
      ...
      if (!userNameInput.value || !passwordInput.value) {
        ...
        loginText.innerHTML += `<h5 class="alert-danger">error:username or password can't be blank</h5>`;
      }
      else{
        ...
        if (parsedUserDataBase.length === 0) {
          ...
          <h3>Username is : ${user.username}</h3>
              ...
              loginText.innerHTML = `
              <h1 class="mx-auto text-center login-text">Login</h1>
              <h5 class="alert-danger">error: user not found ~ 404</h5>`;
            }
          });
        }
      }
